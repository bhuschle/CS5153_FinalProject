...
("iPhone XS, 64GB", "Apple", "cellphones", "iphone", 299.98, "/prodImg/cellphones/iphone/iphonexs_1.jpg", "Picture of the back of a black iPhone XS", "black", "MTA02LL/A", "A Super Retina OLED display. Even faster Face ID. And a breakthrough dual-camera system. The iPhone XS is everything you love about iPhone. Taken to the extreme.", 55),
...
("Galaxy S22, 128GB", "Samsung", "cellphones", "samsung", 699.99, "/prodImg/cellphones/samsung/galaxys22_1.jpg", "Picture of the front of a green Galaxy S22", "green", "SM-S901UZGAXAA ", "For Gen Z, video isn't just video. They think of it as a lifestyle - a universal language for how they learn, grow, express, talk, shop, connect, create, and fight boredom with their friends in real time. ", 17),
...
("Galaxy A52, 128GB", "Samsung", "cellphones", "samsung", 274.99, "/prodImg/cellphones/samsung/galaxya52_1.jpg", "Picture of the front of a black Galaxy A52", "black", "A525F", "Behold the comfortable, sleek curves on Galaxy A52's seamless design. The minimal camera housing blends in with the matte finish on the rear for an iconic, almost unibody look. Express your style with four trendsetting colors: Awesome Violet, Awesome Black, and Awesome White.", 18),
